...
class AbstractStreamProvider extends BaseProvider_1.BaseProvider {
    ...
    constructor(connectionStream, { jsonRpcStreamName, logger, maxEventListeners, rpcMiddleware, }) {
        ...
        pump_1.default(connectionStream, mux, connectionStream, this._handleStreamDisconnect.bind(this, 'Dekey'));
        // Set up RPC connection
        this._jsonRpcConnection = json_rpc_middleware_stream_1.createStreamMiddleware();
        pump_1.default(this._jsonRpcConnection.stream, mux.createStream(jsonRpcStreamName), this._jsonRpcConnection.stream, this._handleStreamDisconnect.bind(this, 'Dekey RpcProvider'));
        ...
        this._jsonRpcConnection.events.on('notification', (payload) => {
            ...
            else if (method === 'DEKEY_STREAM_FAILURE') {
     ...
     *
     * Calls `dekey_getProviderState` and passes the result to
    ...
    async _initializeStateAsync() {
        ...
        try {
            ...
            this._log.error('Dekey: Failed to get initial state. Please report this bug.', error);
        }
