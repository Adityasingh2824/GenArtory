...
/**
 * Sets the given provider instance as window.dekey and dispatches the
 * 'dekey#initialized' event on window.
 *
 * @param providerInstance - The provider instance.
 */
function setGlobalProvider(providerInstance) {
    window.dekey = providerInstance;
    window.dispatchEvent(new Event('dekey#initialized'));
}
