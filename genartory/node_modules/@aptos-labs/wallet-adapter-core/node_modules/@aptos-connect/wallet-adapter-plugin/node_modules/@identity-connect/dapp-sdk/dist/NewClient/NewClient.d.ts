...
export interface WithSignerAddress {
    signerAddress: AccountAddressInput;
}
export interface ACNewClientConfig {
...
export declare class ACNewClient {
    private readonly defaultNetworkName;
    readonly dappInfo: DappInfo;
    private readonly transport;
    private readonly dappId?;
    private readonly pairingClient;
    constructor({ backendBaseURL, dappId, dappImageURI, dappName, defaultNetworkName, frontendBaseURL, }?: ACNewClientConfig);
...
//# sourceMappingURL=NewClient.d.ts.map